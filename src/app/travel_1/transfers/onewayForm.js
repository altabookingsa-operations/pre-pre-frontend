...
const OnewayForm = ({
  ...
  // Only run once on mount to populate form from URL params
  useEffect(() => {
    ...
    if (param('pickUpDate') || param('pickUpTime') || param('pickUpLocation')) {
      ...
      // drop
      setFieldValue('dropOffLatLng', {
        Latitude: Number(param('dLAT')),
        Longitude: Number(param('dLNG')),
      });
      setDropPlaceId(param('dropPlaceId'));
      setFieldValue('dropPlaceId', param('dropPlaceId'));
      setDLocation(param('dropLocation'));
      setFieldValue('dropLocation', param('dropLocation') ? param('dropLocation') : '');
      // time
      ...
      // location type
      setFieldValue('locationTypePick', param('locationTypePick') ? param('locationTypePick') : '');
      setFieldValue('locationTypeDrop', param('locationTypeDrop') ? param('locationTypeDrop') : '');
    }
    ...
    <>
      <div className="row">
        ...
        <div className="col-lg-2 d-none d-lg-block">
          <div
            className="new-double-arrow-img"
            onClick={() => {
              setFieldValue('pickUpLocation', values.dropLocation);
              setFieldValue('dropLocation', values.pickUpLocation);
              setFieldValue('pickUpName', values.dropOffName);
              setFieldValue('dropOffName', values.pickUpName);
              setFieldValue('locationTypeDrop', values.locationTypePick);
              setFieldValue('locationTypePick', values.locationTypeDrop);
              reverseLocation();
            }}
          >
        ...
        <div className="col-lg-5">
          <div className="form-group">
            ...
            <div className="frm-new-icon-box-all">
              <img src="/images/map.png" alt="" />
              <PlaceComponent
                placeholderText="Drop-Off Location"
                onChange={handleChange}
                // onBlur={handleBlur}
                setFieldValue={setFieldValue}
                Location={dLocation}
                setLocation={setDLocation}
                // defaultValue={dLocation}
                setPlaceId={setDropPlaceId}
                type="tranferdrop"
                id="dropLocation"
                setLocationTypePick=""
                setCountryCode={setCountryCode}
                setError={setDropOptionClicked}
                latLngName="dropOffLatLng"
              />
            </div>
            {!dLocation?.length && touched.dropLocation && errors.dropLocation ? (
              <div
                style={{
                  marginTop: '6px',
                  marginLeft: '6px',
              ...
              >
                <span style={{ color: 'red' }}>{errors.dropLocation}</span>
              </div>
            ) : dLocation?.length && dropoptionClicked && !dropPlaceId?.length ? (
              <div
                style={{
                  marginTop: '6px',
                  marginLeft: '6px',
        ...
        <div className="col-lg-4">
          <div className="form-group home-src-dropdown">
            ...
            <div className="dropdown">
              <div className="frm-new-icon-box-all">
                <img src="/images/dropdown-arrow.png" alt="dwn-arrow" />
                <button
                  type="button"
      ...
      {/* Modal */}
      <div className="modal fade" id="transfer-oneway-mobile-sugg-pro-show-details-modal">
...
export default React.memo(OnewayForm);
