  ...
  return (
    <>
      <div className="flex flex-col items-center text-center px-4 lg:px-6 mt-5 lg:mt-[40px]">
        ...
        <div
          className="p-[24px_30px] lg:p-[34px_60px] rounded-full text-gray-200 bg-center bg-cover text-[11px] lg:text-[16px] font-medium mt-[0px] w-[350px] lg:w-[775px] flex items-center justify-center"
          style={{ backgroundImage: "url('images/try-btn33.png')" }}
        >
          <p>
            {answerData}
          </p>
