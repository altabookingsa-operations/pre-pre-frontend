const BoardingPassMobile = () => {
  ...
  <section className="relative pb-[50px] lg:pb-[70px] w-full text-white bg-cover bg-center main-pre-pre-lnch-start " >
    ...
    <div className="text-center pt-[30px] lg:pt-[50px] pb-[20px] text-[#fff]">
      <h1 className="text-[24px] lg:text-[40px] font-semibold">Welcome Aboard, Maria!</h1>
    ...
    <div className=" brdng-pass-midd-bx-mobile w-[96%] min-h-[968px] bg-center bg-cover m-[0_auto] relative " style={{backgroundImage: 'url(images/boarding-pass-back-img-mobile.png)'}}>
      <div className="pt-padd">
        ...
        <div className="p-[15px_30px] all-dtl-bx-mob">
          <div className="relative pb-[1px] mb-[8px]">
            <div className="flex justify-between">
              <div className="w-[50%]">
                <div className="mb-[15px] dtls-mob-txt">
                  <p className="font-regular text-[13px] mb-[5px]">Passenger Full Name</p>
                  <h5 className="font-medium text-[16px] uppercase">Maria Lopez</h5>
                </div>
              </div>
              <div className="w-[40%]">
                <div className="mb-[15px] dtls-mob-txt">
                  <p className="font-regular text-[13px] mb-[5px]">Home City</p>
            ...
            <div>
              <div className="mb-[15px] dtls-mob-txt">
                <p className="font-regular text-[13px] mb-[5px]">Email Address</p>
            ...
            <div className="flex justify-between">
              <div className="w-[50%]">
                <div className="mb-[15px] dtls-mob-txt">
                  <p className="font-regular text-[13px] mb-[5px]">Date of Birth</p>
                  <h5 className="font-medium text-[16px] uppercase">09-07-1989</h5>
                </div>
              </div>
              <div className="w-[40%]">
                <div className="mb-[15px] dtls-mob-txt">
                  <p className="font-regular text-[13px] mb-[5px]">Phone Number</p>
            ...
            <div>
              <div className="mb-[15px] dtls-mob-txt">
                <p className="font-regular text-[13px] mb-[5px]">Nationality</p>
          ...
          <div className="flex items-center justify-between">
            <div className="w-[60%]">
              ...
              <div className="relative">
                ...
                <p className="font-medium text-[16px] text-center mt-[5px] tckt-id-txt">TICKET ID <span className="font-bold ml-[10px]">AB-47291853</span></p>
              </div>
            </div>
            <div className="w-[38%]">
              <img src="images/alta-earlyaccess.png" className="]" />
            </div>
          </div>
          <div className="mt-[33px] bg-center bg-cover min-h-[278px] w-full p-[12px_12px] mobile_checkstatus_back" style={{backgroundImage: 'url(images/mobile_checkstatus_back.png)'}}>
            <div className="flex items-center">
              ...
              <h4 className="font-semibold text-[14px] uppercase">EARLY ACCESS LIMITED</h4>
            </div>
            <div className="pt-[20px]">
              <div className="relative pb-[5px] mb-[5px]">
                <h4 className="font-medium text-[16px] uppercase">Maria Lopez</h4>
                <h4 className="font-medium text-[14px] ">Marialopez@gmail.com</h4>
              ...
              <div className="relative flex justify-between pb-[5px] mb-[5px]">
                <div className="w-[40%]">
                  ...
                  <h4 className="font-medium text-[14px]">London (LHR)</h4>
                </div>
                <div className="absolute left-[0px] w-[12%] right-[19px] top-[20px] m-[0_auto]">
                  <img src="images/new-line.png" alt />
                  <div className="absolute top-[-8px] left-[0px] w-[20px] h-[20px] m-[0_auto] bg-[#3DC7DB] right-[0px] rounded-[50%] flex items-center justify-center"><img src="images/plane3.png" className="w-[15px]" /></div>
                </div>
                <div className="w-[45%]">
                  <h5 className="font-regular text-[12px] min-w-[50px] uppercase">To</h5>
                  <h4 className="font-medium text-[14px]">Alta Booking Early Access(ABE)</h4>
                </div>
                <div style={{position: 'absolute', bottom: 0, width: '100%', height: 1, margin: '0 auto', left: 0, backgroundImage: 'linear-gradient(to right, #fff0, #00CEFF, #fff0)', content: '" "'}} />
              </div>
              <div className="relative pb-[5px] mb-[5px]">
                <table className="w-full">
                  <tbody><tr>
                      ...
                      <td className="text-[14px] font-semibold uppercase tracking-[4px]">5h179lp</td>
                    </tr>
                  </tbody></table>
                <div style={{position: 'absolute', bottom: 0, width: '100%', height: 1, margin: '0 auto', left: 0, backgroundImage: 'linear-gradient(to right, #fff0, #00CEFF, #fff0)', content: '" "'}} />
              </div>
              <div className="relative ">
                <table className="w-full">
                  <tbody><tr>
                      <td className="uppercase font-regular pb-[2px] text-[14px]">Flight <span className="font-semibold ml-[5px]">AB2026</span></td>
                      <td className="uppercase font-regular pb-[2px] text-[14px]">gate <span className="font-semibold ml-[5px]">A1</span></td>
                    </tr>
                    <tr>
    ...
    <div className=" mt-[20px] p-[0px_10px]">
      <button className="flex items-center justify-center bg-center bg-cover min-w-[336px] min-h-[66px] m-[0_auto] mb-[10px]" style={{backgroundImage: 'url(images/brdng-btn1.png)'}}>
        <span className="font-semibold text-[18px] flex items-center gap-2"><img src="images/invite-icon.png" /> Invite Friends</span>
      </button>
      <button className="flex items-center justify-center bg-center bg-cover min-w-[336px] min-h-[66px] m-[0_auto]" style={{backgroundImage: 'url(images/brdng-btn2.png)'}}>
        <span className="font-semibold text-[18px] flex items-center gap-2"><img src="images/share-icon.png" /> Share on Social Media</span>
      </button>
    </div>
  </section>
    )
